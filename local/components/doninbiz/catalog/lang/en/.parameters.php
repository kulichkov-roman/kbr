...
$MESS["CP_BC_SECTION_VIEW_DESC"] = "Display description of the topics";
$MESS["CP_BC_SECTION_VIEW_DESC_OPT_1"] = "Show next to the link under the list of goods";
$MESS["CP_BC_SECTION_VIEW_DESC_OPT_2"] = "Show next to the link above";
$MESS["CP_BC_SECTION_VIEW_DESC_OPT_3"] = "Show under the list of products below";

$MESS["CP_BC_SECTION_VIEW_TOP_LINKS"] = "Displaying links subsections above the list of goods";
$MESS["CP_BC_SECTION_VIEW_SORTING_BLOCK"] = "The display of the block sorting and selecting the type of display products list";
?>