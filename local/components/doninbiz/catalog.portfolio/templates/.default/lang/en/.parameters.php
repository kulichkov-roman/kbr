...
$MESS['FP_LIST_STYLE_NAME'] = 'View the list of works';
$MESS['FP_LIST_STYLE_ALL'] = 'user';
$MESS['FP_LIST_STYLE_GRID'] = 'Tile';
$MESS['FP_LIST_STYLE_LIST'] = 'List';
$MESS['FP_LIST_STYLE_DEFAULT_NAME'] = 'View the default display';

$MESS["FP_TPL_USE_SOCIAL_BAR"] = "Show social icons";

$MESS['FP_BC_TPL_TEXT_ORDER_SERVICE'] = 'the name of the button of the order of service';
$MESS['FP_BC_TPL_TEXT_ORDER_SERVICE_DEFAULT'] = 'Book project';
$MESS['FP_BC_TPL_TEXT_ORDER_QUESTION'] = 'the name of the button the order of the question';
$MESS['FP_BC_TPL_TEXT_ORDER_QUESTION_DEFAULT'] = 'Ask a question';

$MESS['FP_BC_TPL_TEXT_TEAM'] = 'Title block employees details page';
$MESS['FP_BC_TPL_TEXT_TEAM_DEFAULT'] = 'Project completed';
$MESS['FP_BC_TPL_TEXT_SERVICES'] = 'Title block service details page';
$MESS['FP_BC_TPL_TEXT_SERVICES_DEFAULT'] = 'Services';
$MESS['FP_BC_TPL_TEXT_PORTFOLIO'] = 'Title block similar works details page';
$MESS['FP_BC_TPL_TEXT_PORTFOLIO_DEFAULT'] = 'Similar work';

$MESS['FP_BC_TPL_TEXT_PROPERTIES'] = 'Title block characteristics';
$MESS['FP_BC_TPL_TEXT_PROPERTIES_DEFAULT'] = 'Features';
$MESS['FP_BC_TPL_TEXT_DESCRIPTION'] = 'Title block detailed description';
$MESS['FP_BC_TPL_TEXT_DESCRIPTION_DEFAULT'] = 'Full description';
?>