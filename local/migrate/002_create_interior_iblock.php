 ...
 */
class CreateInteriorSliderIBlockMigration extends AbstractIBlockMigration
{
	/**
	 * {@inheritdoc}
	 */
	public function up()
	{
		...
		try {
			...
			$logger->log(
				sprintf('IBlock interiorMain has been created. Id: "%s". Add to "interiorIBlockId"', $this->iblockId)
			);
...
$migration = new CreateInteriorSliderIBlockMigration();
$migration->up();
